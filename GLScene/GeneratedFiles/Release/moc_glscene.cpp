...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GLScene_t, stringdata) + ofs \
...
const QMetaObject GLScene::staticMetaObject = {
    { &QGLViewer::staticMetaObject, qt_meta_stringdata_GLScene.data,
      qt_meta_data_GLScene,  qt_static_metacall, 0, 0}
};
